...
public class SimpleTypeConverter implements CatoTypeConverter {
    ...
    final int integerLength = Integer.toString(Integer.MAX_VALUE).length();
    final int longLength = Long.toString(Long.MAX_VALUE).length();
    ...
    SimpleTypeConverter(int precision, String... dateFormats) {
        this.precision = precision;
        this.dateFormats = this.createDateFormats(dateFormats);
    }

    SimpleTypeConverter(String... dateFormats) {
