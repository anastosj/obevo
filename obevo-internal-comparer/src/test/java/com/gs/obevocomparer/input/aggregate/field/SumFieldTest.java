...
public class SumFieldTest {
    ...
    public void testGetValue() {
        ...
        this.field = new SumField("Val 1");

        Assert.assertEquals(6.8, (double) this.field.getValue(objs), 0.01);
    }
