...
### 1) Java 17 for build and runtime / usage
...
Note:
* Language: Java 17 syntax (all modules compile with `--release 17`) and Kotlin.
* The Obevo binary byte code is Java 17, so a Java 17+ runtime is required to use Obevo.
* Travis CI builds and tests against JDK 17.
